...
TA_UUID := ff2a4bea-ef6d-11e6-89cc-d4ae52a7b3b3
TA_SUFFIX := .ta

ifeq ($(PLATFORM_TDK_VERSION), 38)
PLATFORM_TDK_PATH := $(BOARD_AML_VENDOR_PATH)/tdk_v3
	ifeq ($(filter A311D2 POP1 S905C2 S905C2ENG S905X4 S805X2 S805X2G S905Y4 T965D4 T963D4 T982, $(BOARD_AML_SOC_TYPE)),)
